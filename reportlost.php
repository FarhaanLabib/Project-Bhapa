...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($animal) || empty($lastseen) || empty($datereported)) {
        ...
        $stmt = $conn->prepare("INSERT INTO lost_pets (animal, breed, age, name, lost_at, date_reported) VALUES (?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("ssssss", $animal, $breed, $age, $name, $lastseen, $datereported);
...
<head>
  ...
  <title>Bhapa - Report Lost Pet</title>
  ...
  <style>
    ...
    * {
    ...
    .submit-btn:hover {
      ...
      box-shadow: 0 8px 25px rgba(255, 107, 97, 0.3);
    }
  ...
  <div class="container">
    <div class="header-content">
      ...
      <nav>
        ...
        <a href="reportlost.php" class="active">REPORT LOST</a>
      </nav>
    </div>
  </div>
</header>
  ...
  <div class="container">
    <div class="form-container">
      <div class="form-title">
        <h2><i class="fas fa-search"></i>Report Lost Pet</h2>
        <p>Help us find your missing pet</p>
      </div>
      ...
      <form method="POST">
        ...
        <div class="form-group">
          ...
          <input type="text" name="lastseen" placeholder="Location where you last saw your pet" required>
        </div>
        <div class="form-group">
